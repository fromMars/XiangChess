...
class BaseBoard:
    def __init__(self, orig_pos):
        ...
        self.__bgcolor = (0, 0, 0, 255)
        self.__linecolor = (255, 255, 255, 255)
        self.__origin_position = orig_pos
        self.__vertical_spacing = 36
    ...
    def __create_text(self, x, y):
        ...
        self.__hanjie = pyglet.text.Label('汉界', font_name = 'msyh', 
                                      font_size = 12, bold = True,
                                      color = color,
                                      anchor_x = 'center',
                                      anchor_y = 'center',
    ...
    def __create_gap(self, x_orig, y_orig, x_right, y_enl):
        ...
        vertex_edge_color = (255, 255, 255, 255,
                             255, 255, 255, 255,
                             255, 255, 255, 255,
                             255, 255, 255, 255)
